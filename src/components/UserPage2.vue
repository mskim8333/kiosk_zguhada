<template>
  <div class="addrpage">
    ...
    <h3>신청인의 연락처를 입력해주세요.</h3>
    <div class="ip_row">
      <div>
        <input :value="keyValue" maxlength="15" placeholder="전화번호를 입력해주세요." readonly>
      </div>
    </div>
    <div class="keyboard">
      <div v-for="(keyLine, index) in KeyData[lang]" :key="index">
        <ul>
          <li
            ...
            @click="() => keyEvent(key)"
          >
            <span class="keyInfo keySpace" v-if="key === 'space'">{{ key }}</span>
            <span class="keyInfo keySearch" v-else-if="key === 'search'">
              <!--<img src="../assets/search.png" />-->검색
            </span>
            <span class="keyInfo keyShift" v-else-if="key === 'Shift' && shiftIndex === 0">
              <img src="../assets/upper.png" />
            </span>
            <span class="keyInfo keyShift2" v-else-if="key === 'Shift' && shiftIndex === 1">
              <img src="../assets/upper2.png" />
            </span>
            <span class="keyInfo keyBackspace" v-else-if="key === 'BackSpace'">
              <img src="../assets/delete.png" />
            </span>
            <span class="keyInfo keyLang" v-else-if="key === '한/영'">{{ key }}</span>
            <span class="keyInfo" v-else>{{ key }}</span>
          </li>
        </ul>
      </div>
    </div>
