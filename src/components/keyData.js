const kr = [
  ...
  [
    ['ㅁ', 'ㅁ'], ['ㄴ', 'ㄴ'], ['ㅇ', 'ㅇ'], ['ㄹ', 'ㄹ'], ['ㅎ', 'ㅎ'], ['ㅗ', 'ㅗ'], ['ㅓ', 'ㅓ'], ['ㅏ', 'ㅏ'], ['ㅣ', 'ㅣ'], ['-', '_']
  ],
  [
    ['Shift', 'Shift'], ['ㅋ', 'ㅋ'], ['ㅌ', 'ㅌ'], ['ㅊ', 'ㅊ'], ['ㅍ', 'ㅍ'], ['ㅠ', 'ㅠ'], ['ㅜ', 'ㅜ'], ['ㅡ', 'ㅡ'], ['BackSpace', 'BackSpace']
  ],
  [
    ['한/영', '한/영'], ['space', 'space'], ['search', 'search']
  ]
]
...
const en = [
  ...
  [
    ['Shift', 'Shift'], ['z', 'Z'], ['x', 'X'], ['c', 'C'], ['v', 'V'], ['b', 'B'], ['n', 'N'], ['m', 'M'], ['BackSpace', 'BackSpace']
  ],
  [
    ['한/영', '한/영'], ['space', 'space'], ['search', 'search']
  ]
